<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReplaaceTemplate.aspx.cs" Inherits="PaymentGetway.ReplaaceTemplate" %>
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch price monthly">
                <div class=" Plan1 monthly">
                   ...
                   <span class="price monthly">$200 <p>/ 6 Month</p></span>
                    ...
                    <asp:Button ID="Button4" runat="server" Text="Pay Now" class="btn" OnClick="BtnRazorPay_Click" />
                    <div class="Ulli">
                        <ul>
